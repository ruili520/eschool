/*
 * Created by uchung on 2019/7/31.
 */
export default {
  '北京市':{
    '北京市':['石景山区','门头沟区','东城区', '西城区', '崇文区', '宣武区', '朝阳区', '丰台区', '海淀区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区', '密云县', '延庆县']
  },
  '天津市':{
    '天津市':['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '塘沽区', '汉沽区', '大港区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '宁河县', '静海县', '蓟县']
  },
  '河北省':{
    '石家庄市':['井陉矿区','赵县','长安区','桥东区','桥西区','新华区','裕华区','井陉县','正定县','栾城县','行唐县','灵寿县','高邑县','深泽县','赞皇县','无极县','平山县','元氏县','辛集市','藁城市','晋州市','新乐市','鹿泉'],
    '唐山市':['滦县','路南区','路北区','古冶区','开平区','丰南区','丰润区','滦南县','乐亭县','迁西县','玉田县','唐海县','遵化市','迁安市'],
    '秦皇岛市':['山海关区','北戴河区','青龙满族自治县','海港区','昌黎县','抚宁县','卢龙县'],
    '邯郸市':['峰峰矿区','涉县','磁县','邱县','魏县','邯山区','丛台区','复兴区','邯郸县','临漳县','成安县','大名县','肥乡县','永年县','鸡泽县','广平县','馆陶县','曲周县','武安市'],
    '邢台市':['任县','威县','桥东区','桥西区','邢台县','临城县','内丘县','柏乡县','隆尧县','南和县','宁晋县','巨鹿县','新河县','广宗县','平乡县','清河县','临西县','南宫市','沙河市'],
    '保定市':['唐县','高碑店市','易县','蠡县','新市区','北市区','南市区','满城县','清苑县','涞水县','阜平县','徐水县','定兴县','高阳县','容城县','涞源县','望都县','安新县','曲阳县','顺平县','博野县','涿州市','定州市','安国市','雄县'],
    '张家口市':['蔚县','下花园区','桥东区','桥西区','宣化区','宣化县','张北县','康保县','沽源县','尚义县','阳原县','怀安县','万全县','怀来县','涿鹿县','赤城县','崇礼县'],
    '承德市':['鹰手营子矿区','双桥区','双滦区','承德县','兴隆县','平泉县','滦平县','隆化县','围场满族蒙古族自治县','宽城满族自治县','丰宁满族自治县'],
    '沧州市':['沧县','青县','孟村回族自治县','新华区','运河区','东光县','海兴县','盐山县','肃宁县','南皮县','吴桥县','泊头市','任丘市','黄骅市','河间市','献县'],
    '廊坊市':['大厂回族自治县','安次区','广阳区','固安县','永清县','香河县','大城县','文安县','霸州市','三河市'],
    '衡水市':['景县','桃城区','枣强县','武邑县','武强县','饶阳县','安平县','故城县','阜城县','冀州市','深州市']
  },
  '山西省':{
    "太原市":['杏花岭区','尖草坪区','小店区','迎泽区','晋源区','清徐县','阳曲县','娄烦县','古交市','万柏林区'],
    "大同市":['城区','南郊区','新荣区','阳高县','天镇县','广灵县','灵丘县','浑源县','左云县','大同县','矿区'],
    "阳泉市":['城区','矿区','郊区','平定县','盂县'],
    "长治市":['城区','沁县','郊区','长治县','襄垣县','屯留县','平顺县','黎城县','壶关县','长子县','武乡县','沁源县','潞城市'],
    "晋城市":['城区','沁水县','阳城县','陵川县','泽州县','高平市'],
    "朔州市":['朔城区','平鲁区','山阴县','应县','右玉县','怀仁县'],
    "晋中市":['祁县','榆次区','榆社县','左权县','和顺县','昔阳县','寿阳县','太谷县','平遥县','灵石县','介休市'],
    "运城市":['绛县','夏县','盐湖区','临猗县','万荣县','闻喜县','稷山县','新绛县','垣曲县','平陆县','芮城县','永济市','河津市'],
    "忻州市":['代县','忻府区','定襄县','五台县','繁峙县','宁武县','静乐县','神池县','五寨县','岢岚县','河曲县','保德县','偏关县','原平市'],
    "临汾市":['古县','吉县','尧都区','曲沃县','翼城县','襄汾县','洪洞县','安泽县','浮山县','乡宁县','大宁县','永和县','汾西县','侯马市','霍州市','隰县','蒲县'],
    "吕梁市":['兴县','临县','离石区','文水县','交城县','柳林县','石楼县','方山县','中阳县','交口县','孝义市','汾阳市','岚县']
  },
  '内蒙古自治区':{
    "呼和浩特市":['土默特左旗','清水河县','新城区','回民区','玉泉区','赛罕区','武川县','和林格尔县','托克托县'],
    "包头市":['东河区','昆都仑区','青山区','石拐区','白云矿区','九原区','土默特右旗','固阳县','达尔罕茂明安联合旗'],
    "乌海市":['海勃湾区','海南区','乌达区'],
    "赤峰市":['元宝山区','阿鲁科尔沁旗','红山区','松山区','林西县','宁城县','敖汉旗','克什克腾旗','巴林左旗','巴林右旗','翁牛特旗','喀喇沁旗'],
  ...
  '黑龙江省':{
    "哈尔滨市":['宾县','道里区', '南岗区', '道外区', '太平区', '香坊区', '动力区', '平房区', '呼兰县', '依兰县', '方正县', '巴彦县', '木兰县', '通河县', '延寿县', '阿城市', '双城市', '尚志市', '五常市'],
    "齐齐哈尔市":['昂昂溪区','富拉尔基区','碾子山区','龙沙区', '建华区', '铁锋区', '龙江县', '依安县', '泰来县', '甘南县', '富裕县', '克山县', '克东县', '拜泉县', '讷河市','梅里斯达斡尔族区'],
    "鸡西市":['城子河区','鸡冠区', '恒山区', '滴道区', '梨树区', '麻山区', '鸡东县', '虎林市', '密山市'],
    "鹤岗市":['向阳区', '工农区', '南山区', '兴安区', '东山区', '兴山区', '萝北县', '绥滨县'],
    "双鸭山市":['四方台区','尖山区', '岭东区', '宝山区', '集贤县', '友谊县', '宝清县', '饶河县'],
    "大庆市":['萨尔图区','让胡路区','杜尔伯特蒙古族自治县','龙凤区', '红岗区', '大同区', '肇州县', '肇源县', '林甸县'],
    "伊春市":['金山屯区','乌马河区','汤旺河区','乌伊岭区','上甘岭区','伊春区', '南岔区', '友好区', '西林区', '翠峦区', '新青区', '美溪区', '五营区', '带岭区', '红星区', '嘉荫县', '铁力市'],
    "佳木斯市":['郊区','永红区', '向阳区', '前进区', '东风区', '桦南县', '桦川县', '汤原县', '抚远县', '同江市', '富锦市'],
    "七台河市":['新兴区','桃山区','茄子河区','勃利县'],
    "牡丹江市":['绥芬河市','东安区', '阳明区', '爱民区', '西安区', '东宁县', '林口县', '海林市', '宁安市', '穆棱市'],
    "黑河市":['爱辉区', '嫩江县', '逊克县', '孙吴县', '北安市','五大连池市'],
    "绥化市":['北林区', '望奎县', '兰西县', '青冈县', '庆安县', '明水县', '绥棱县', '安达市', '肇东市', '海伦市'],
    "大兴安岭地区":['呼玛县','塔河县','漠河县']
  },
  '上海市':{
    '上海市':['浦东新区','黄浦区','卢湾区','徐汇区','长宁区','静安区','普陀区','闸北区','虹口区','杨浦区','闵行区','宝山区','嘉定区','金山区','松江区','青浦区']
  },
  "江苏省":{
    "南京市":['玄武区', '白下区', '秦淮区', '建邺区', '鼓楼区', '下关区', '浦口区', '栖霞区', '江宁区', '六合区', '溧水县', '高淳县', '雨花台区'],
    "无锡市":['崇安区', '南长区', '北塘区', '锡山区', '惠山区', '滨湖区', '江阴市', '宜兴市'],
    "徐州市":['丰县','鼓楼区', '云龙区', '九里区', '贾汪区', '泉山区', '铜山县', '睢宁县', '新沂市', '邳州市','沛县'],
    "常州市":['天宁区', '钟楼区', '新北区', '武进区', '溧阳市', '金坛市', '戚墅堰区'],
    "苏州市":['张家港市','沧浪区', '平江区', '金阊区', '虎丘区', '吴中区', '相城区', '常熟市', '昆山市', '吴江市', '太仓市'],
    "南通市":['崇川区', '港闸区', '海安县', '如东县', '启东市', '如皋市', '通州区', '海门市'],
  ...
  "浙江省":{
    ...
    "丽水市":["莲都区", "青田县", "缙云县", "遂昌县", "云和县", "庆元县", "景宁畲族自治县", "龙泉市"]
  },
  "安徽省":{
    "合肥市" :["瑶海区", "庐阳区", "蜀山区", "包河区", "长丰县", "肥东县", "肥西县"],
    "芜湖市" :["镜湖区", "马塘区", "新芜区", "鸠江区", "芜湖县", "繁昌县", "南陵县"],
    "蚌埠市" :["南陵县", "东市区", "中市区", "西市区", "郊区", "怀远县", "五河县", "固镇县"],
  ...
  "福建省":{
    ...
    "三明市":["梅列区", "三元区", "明溪县", "清流县", "3504", "宁化县", "大田县", "尤溪县", "沙县", "将乐县", "泰宁县", "建宁县"],
  ...
  "河南省":{
    ...
    "平顶山市":["新区", "卫东区", "石龙区", "湛河区", "宝丰县", "叶县", "鲁山县", "郏县", "舞钢市", "汝州市"],
  ...
  "湖北省":{
    ...
    "襄阳市":["襄城区", "樊城区", "襄阳区", "南漳县", "谷城县", "保康县", "老河口市", "枣阳市", "宜城市"],
    "鄂州市":["梁子湖区", "华容区", "鄂城区"],
  ...
  "广东省":{
    ...
    "韶关市":["北江区", "武江区", "浈江区", "曲江县", "始兴县", "仁化县", "翁源县", "乳源瑶族自治县", "新丰县", "乐昌市", "南雄市"],
  ...
  "广西壮族自治区":{
    "南宁市":["兴宁区", "新城区", "城北区", "江南区", "永新区", "邕宁区", "武鸣县", "隆安县", "马山县", "上林县", "宾阳县", "横县"],
    ...
    "河池市":["富川瑶族自治县", "金城江区", "南丹县", "天峨县", "凤山县", "东兰县", "罗城仫佬族自治县", "环江毛南族自治县", "巴马瑶族自治县", "都安瑶族自治县", "大化瑶族自治县"],
  ...
  "重庆市":{
    '重庆市':['石柱土家族自治县','大渡口区','沙坪坝区','九龙坡区','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县','忠县','开县','万州区','涪陵区','渝中区','江北区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区','綦江县','潼南县','铜梁县','大足县','荣昌县','璧山县','梁平县','城口县','丰都县','垫江县','武隆县','云阳县','奉节县','巫山县','巫溪县','江津区','合川区','永川区','南川区']
  },
  ...
  "贵州省":{
    ...
    '铜仁地区':['铜仁市','江口县','屏侗族自治县','石阡县','思南县','印江土家族苗族自治县','德江县','沿河土家族自治县','松桃苗族自治县','万山特区'],
  ...
  "云南省":{
    '昆明市':['五华区','盘龙区','渡区','西山区','东川区','呈贡县','晋宁县','富民县','宜良县','石林彝族自治县','嵩明县','禄劝彝族苗族自治县','寻甸回族彝族自治县','安宁市'],
  ...
  "甘肃省":{
    '兰州市':['城关区','七里河区','西固区','安宁区','红古区','永登县','皋兰县','中县'],
    '嘉峪关市':['嘉峪关市'],
    '金昌市':['金川区','永昌县'],
    ...
    '陇南地区':['武都县','宕昌县','成县','康县','文县','西和县','礼县','两当县','徽县'],
  ...
  "新疆维吾尔自治区":{
    ...
    "巴音郭楞蒙古自治州":['轮台县', '尉犁县', '若羌县', '且末县', '和静县', '和硕县', '博湖县', '库尔勒市','焉耆回族自治县'],
    "阿克苏地区":['阿瓦提县','温宿县', '库车县', '沙雅县', '新和县', '拜城县', '乌什县', '柯坪县', '阿克苏市'],
    "克孜勒苏柯尔克孜自治州":['乌恰县','阿合奇县','阿克陶县','阿图什市'],
    "喀什地区":['塔什库尔干塔吉克自治县','英吉沙县','麦盖提县','喀什市', '疏附县', '疏勒县', '泽普县', '莎车县', '叶城县', '伽师县', '巴楚县','岳普湖县'],
    "和田地区":['和田市', '和田县', '墨玉县', '皮山县', '洛浦县', '策勒县', '于田县', '民丰县'],
    "伊犁哈萨克自治州":['特克斯县','尼勒克县','伊宁市', '奎屯市', '伊宁县', '霍城县', '巩留县', '新源县', '昭苏县','察布查尔锡伯自治县'],
    "塔城地区":['和布克赛尔蒙古自治县','塔城市', '乌苏市', '额敏县', '沙湾县', '托里县', '裕民县'],
    "阿勒泰地区":['青河县','阿勒泰市', '布尔津县', '哈巴河县', '吉木乃县','福海县','富蕴县']
  }
  //"台湾":{
