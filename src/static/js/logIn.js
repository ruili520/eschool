  ...
  function logIn(data) {
    ...
    window.native.ObtainICBCEnvironment(function (state) {
      ...
      if (state.code == "0") {
        ...
        // {
        //   ICBCUserInfoXML: '',
        //     ICBCKEY: 'RuBII3v+lRwbXrFZKTmNKdsR+L7IbFF4UVNePTy5Ouc1EGaaLfzgiW6KWGEOwCTfkhDUA7v64Nu8wG2uOQtMRwxPrjsz58RWXiVR0yVMR+1JrS4y2tI4HxaH2ka/aAfc6Ms3U/BW68+UIJ+Ua+NJ92FFcozscmlKZMTLggkA/1w=',
        //   contactType: 2001
        // }
        loginICBCLONG({
...
export function shortLogIn(data, callback) {
  ...
  getSessionId().then(function (data) {
    ...
    if (data.data.code == "000001") {
      Indicator.close()
      let sessionId = data.data.result.sessionId;
